...
public class TelaPesquisaFuncionario extends javax.swing.JFrame {
   ...
   private List<Funcionario> funcinarios = new ArrayList<>();
   private Funcionario funcionario = new Funcionario();
    ...
    private void pesquisar(){        
        ...
        try {            
            ...
            this.funcinarios = (List<Funcionario>) dao.pesquisar(funcionario);
        }catch(Exception e){
            e.printStackTrace();
        }           
    ...
    private void carregarTabela(){
        pesquisar();
        tabelaFuncionario.setModel(new TabelaModeloFuncionario(funcinarios));
    }
    ...
    private void verDetalhes(){
        TelaVerDetalhesFuncionario telaFuncinarioDetalhes = new TelaVerDetalhesFuncionario(funcionario);
        telaFuncinarioDetalhes.setVisible(true);
    }
    
    private void alterar(){
        TelaFormularioFuncionario alterar = new TelaFormularioFuncionario(funcionario);
    ...
    private void selecionarCliente(MouseEvent evt){
        ...
        if(linha >= 0){
            ...
            this.funcionario = funcinarios.get(linha);            
        }
    }
    ...
    private void initComponents() {
        ...
        tabelaFuncionario.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
    ...
    private void campoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoCadastrarActionPerformed
        TelaFormularioFuncionario telaCadastro= new TelaFormularioFuncionario(funcinarios);
